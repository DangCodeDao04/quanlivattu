...
public class UpdateKhachHang extends javax.swing.JFrame {
    ...
    public UpdateKhachHang(String makhachhang) throws SQLException, ClassNotFoundException {
        initComponents();
        ...
        set_thuoc_tinh(makhachhang);
    }
    
    public void set_thuoc_tinh(String makhachhang) throws SQLException, ClassNotFoundException{
        KhachHang_md khachhang = new KhachHang_md();
        ResultSet rs = khachhang.GetData();
        while(rs.next()){
            if(rs.getString("MaKH").equals(makhachhang) == true){
    ...
    private void btcapnhatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btcapnhatMouseClicked
        ...
        try {
            KhachHang_md khachhang = new KhachHang_md();
            khachhang.Fix(makhachhang, tenkhachhang, diachi, sodienthoai);
            khachhang.Close();
