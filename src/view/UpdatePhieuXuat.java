 ...
 * @author HoangHiep
 */
public class UpdatePhieuXuat extends javax.swing.JFrame {

    public UpdatePhieuXuat(String maphieuxuat) throws SQLException, ClassNotFoundException {
        initComponents();
        ...
        set_thuoc_tinh(maphieuxuat);
    }
    
    public void set_thuoc_tinh(String maphieuxuat) throws SQLException, ClassNotFoundException{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CẬP NHẬT PHIẾU XUẤT");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(tfmaphieuxuat, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(60, 60, 60)
    ...
    private void btcapnhatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btcapnhatMouseClicked
        ...
        try {
            PhieuXuat_md phieuxuat = new PhieuXuat_md();
            phieuxuat.CapNhapTrangThai(maphieuxuat, trangthai);
            JOptionPane.showMessageDialog(this, "Thay đổi thông tin thành công!");
            phieuxuat.Close();
        } catch (SQLException ex) {
            Logger.getLogger(UpdatePhieuXuat.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new UpdatePhieuXuat("").setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(UpdatePhieuXuat.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(UpdatePhieuXuat.class.getName()).log(Level.SEVERE, null, ex);
