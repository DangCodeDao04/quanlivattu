...
public class UpdateKho extends javax.swing.JFrame {
    ...
    public UpdateKho(String makho) throws SQLException, ClassNotFoundException {
        initComponents();
        ...
        set_thuoc_tinh(makho);
    }
    
    public void set_thuoc_tinh(String makho) throws SQLException, ClassNotFoundException{
        Kho_md kho = new Kho_md();
        ResultSet rs = kho.GetData();
        while(rs.next()){
            if(rs.getString("MaKho").equals(makho) == true){
                tfmakho.setText(rs.getString("MaKho"));
                tfmakho.setEditable(false);
                tftenkho.setText(rs.getString("TenKho"));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new UpdateKho("").setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(UpdateKho.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(UpdateKho.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
